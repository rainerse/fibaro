...
%% globals
--]]
local temp_andur            = 1347;      -- temperatuuriandur
...
if(temperatuur_tegelik) < (temperatuur_sulgemine) then; ------------------------------------------------------------------------------
    print('<font color=lightblue> # 19 Temperatuur on alla ' .. temperatuur_sulgemine ..' kraadi. Kontrollin kas aken on lahti.');  --
    if (akna_olek == 1) then -------------------------------------------------------                                                --
...
elseif (temperatuur_tegelik) > (temperatuur_avamine)) then                                                                          --
    print('<font color=lightblue> # 27 Temperatuur on üle ' .. temperatuur_avamine .. ' kraadi, kontrollin kas aken on kinni');     --
    if (akna_olek) ==0) then -------------------------------------------------------                                                --
